...
if (isset($_REQUEST['submit']))
{
        ...
        if(mail($mailTo,$sb, $txt,$headers))
        {
            $meassage ='<div class="alert alert success col-sm-6 ml-5 mt-2" role="alert">Sent Successfully </div>';
            echo $meassage;
        }
        else
        {
...
<div class="form-group">
    <div class="Sent_Msg" >
        ...
        <input type="text" class="form-control" name="email" id="" placeholder="Email"><br>
            <input type="text" class="form-control" name="subject" id="" placeholder="Subject"><br>
          
            <textarea name="msg" class="form-control" id="" cols="50    " rows="5" placeholder="Type Your Message Here" ></textarea><br>
