<?php
    ...
    <?php
        if($x == 0)
        require 'Partial/_navlogscroll.html';
        $sql = "SELECT Date FROM bill1 WHERE Appoinment_Id = $aid[$x]";
        $result = mysqli_query($con,$sql);
        $row=mysqli_fetch_array($result);
        $d=$row['Date'];
        $z= date('d/M/y', strtotime($d));
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                {
                                ?>
                                    <a class="btn btn-sm btn-secondary float-right mr-1 d-print-none" href="indexpay.php?name=<?php echo $bid ;?>"  data-abc="true">
                                    <i class="fa fa-print"></i> Pay Now</a>
                                <?php
                                }
                            ?>
                            </div>
