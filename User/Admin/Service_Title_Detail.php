...
<body >
  ...
  <br><br><br>
  <a href="Service_Title.php" style="margin-left:220px;text-decoration:none;color:#ea6b00;"><i class="fa fa-plus" style="font-size:24px">Add Service Title</i></a><br><br>
  ...
  <table >
    <tr style="background-color:#2a3f54;color:#ea6b00;">
      ...
      ?>  
      <tr><form action="Delete Service Title Page.php" method="post">
        <td><?php echo $row['Servic_Title'];?></td>
        <td><img  src="<?php echo $d;?>"></td>
