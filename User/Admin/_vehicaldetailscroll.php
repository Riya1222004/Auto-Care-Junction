...
<body >
  ...
  <br><br><br>
  <a href="_addvehicle.php" style="margin-left:220px;text-decoration:none;color:#ea6b00;"><i class="fa fa-plus" style="font-size:24px"> Add Vehicle</i></a><br><br>
  ...
  <table >
    ...
    <?php
        ...
        $que="SELECT * FROM `vehicle` ";
        $result=mysqli_query($con,$que);
        while($row=mysqli_fetch_array($result))
        {
      ?>  
    <tr><form action="Vehicle_View.php" method="post">
      <td><?php 
         $id = $row['U_Id'];
