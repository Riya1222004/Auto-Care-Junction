				...
				<div class="nav_menu">
					<nav>
						<div class="nav toggle">
							<a id="menu_toggle"><i class="fa fa-bars"></i><span class="titleup">&nbsp Email Template</span></a>  
						</div>
						<ul class="nav navbar-nav navbar-right">
			
		  <ul class="dropdown-menu dropdown-usermenu pull-right">
			<li><a href="http://localhost/php_practicle/garage/setting/profile"> Profile</a></li>
		 		 							<li> <a href="http://localhost/php_practicle/garage/setting/general_setting/list"><span>Settings</span></a></li>
								<li><a href="#" onclick="event.preventDefault();document.getElementById('logout-profile').submit();"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
			<form id="logout-profile" action="http://localhost/php_practicle/garage/logout" method="POST" style="display: none;">
						<input type="hidden" name="_token" value="hdpHlgMNjnehaWMGPTO5yVObUWPwC98jI3okPlWa">				</form>
			</li>
		  </ul>
		</li>
 ...
 <br></strong></label>
													...
													<div class="form-group">
														...
														<label class="radio-inline">
															<input type="radio" name="is_send"  value="0"  checked >Enable
														</label>
														<label class="radio-inline">
															<input type="radio" name="is_send"  value="1" >Disable
														</label>
													</div>	
													</div>
