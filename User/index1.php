  ...
  <img src="Customer/logog.PNG" alt="nop[" >
      ...
      <td>
        <div class="container red topBotomBordersOut">
          ...
          <a href="Customer/bot.php">Chat</a>
        ...
        <center><div style=" background-color: #ea6b00; padding: 5px;color: 2a3f54;font-size: 20p;width:1519.5px;">
            Welcome !! <a href="Login.php" style="color: rgb(235, 223, 223);"> Log In</a> To Our Website Get More Benifits For your Vehicle Services
        </div></center>
  <img src="Customer/a1.jpg" alt="" srcset="" >
...
function carousel() {
  ...
  setTimeout(carousel, 4000); // Change image every 2 seconds
           ...
           <div class="about" style="margin-top: 80px; ">
               <center>
                <a href="Customer/AboutUs.php" class="fa fa-users" style="font-size:48px;color:rgb(0, 0, 0); background-color:whitesmoke ; margin-top: 40px; border-radius: 60px; padding: 20px;text-decoration: none;" >
                   </a>
               <h3>About Us</h3>
               </center>
           </div>
           <div class="contact" style="margin-top: 100px;">
            <center>
             <a href="Customer/ContactUs.php" class="fa fa-map-marker" style="font-size:48px;color:rgb(0, 0, 0); background-color:whitesmoke ; margin-top: 40px; border-radius: 60px; padding: 20px;text-decoration: none; width: 70px;" ></a>
            <h3>Contact Us</h3>
            </center>
            </div>
            ...
            <table style="margin-left: 55px;margin-top: 50px;margin-bottom: 50px;">
                <tr>
                    <td style="padding: 12px;">
                        <div id="cf">
                            <img class="bottom" src="Customer/11.jpg" width="100%">
                            <img class="top" src="Customer/22.jpg" width="100%">
                          </div>
                    </td>
                    <td style="padding: 12px;">
                        <div id="cf">
                            <img class="bottom" src="Customer/33.jpg" width="100%">
                            <img class="top" src="Customer/44.jpg" width="100%">
                          </div>
                    </td style="padding: 12px;">
                    <td style="padding: 12px;">
                        <div id="cf">
                            <img class="bottom" src="Customer/55.jpg" width="100%">
                            <img class="top" src="Customer/66.jfif" width="100%">
                          </div>
                    </td>
                </tr>
            </table>
